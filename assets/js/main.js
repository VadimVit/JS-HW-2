...
let wordsList = (str, subStr) => {
    ...
    let arr1 = str1.split(" ");
    console.log(arr1)
    let arr2 = arr1.filter(function (word) {
        return word.includes(subStr)
    });
...
function getLocalDate(date, isSeconds, isISO) {
    ...
    if (isSeconds === true) {
        ...
        return isISO === true ? dateISO + ', ' + longH : date1 + ', ' + longH
    }
    else {
        return isISO === true ? dateISO + ', ' + shortH : date1 + ', ' + shortH
    }
}

console.log(new Date(123456));
console.log(new Date(1999999123456));
...
console.log(getLocalDate(new Date(1999999123456), true));
console.log(getLocalDate(new Date(1999999123456), false, true));
console.log(getLocalDate(new Date(1999999123456), true, true));
...
function getDateAgo(date, days) {
    ...
    let lastdate = date3;
    lastdate.setDate(date3.getDate() - days);
...
const Car = function (engine, model, name, year, _used) {
    this.engine = engine;
    this.model = model;
    this.name = name;
    this.year = year;
